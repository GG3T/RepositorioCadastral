...
public class Conta_clienteDAO extends DAO {
	...
	// m�todo para INSERT de conta na tabela
	...
	// m�todo para SELECT os dados da conta cadastrados na base de dados
...
/*
 * m�todo para UPDATE o tipo de cliente na conta public void
