...
public class Cliente {
    ...
    public Cliente(int id_cliente, String telefone01, String telefone02, String tp_cliente, String email, String ind_cliente_novo, String senha) {
    ...
    public int getId_cliente () {
        ...
        public int setId_cliente (int id_cliente){
        this.id_cliente = id_cliente;
            return 0;
        }
